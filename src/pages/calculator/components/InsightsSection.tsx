      ...
      <div className="space-y-5">
        ...
        <AccordionItem title="🚀 자산 순위를 높이는 실전 재테크 팁" bgColor={pastelColors[3]}>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-gray-500">
            ...
            <li><strong className="font-bold text-navy-light">부채 현명하게 활용:</strong> 좋은 부채(투자 목적)와 나쁜 부채(소비 목적)를 구분하고, 이자율 낮은 대출 우선 상환.</li>
            <li><strong className="font-bold text-navy-light">절세 전략 숙지:</strong> 연금저축, ISA, 비과세 상품 등 다양한 절세 혜택을 활용하여 세금 부담 최소화.</li>
            <li><strong className="font-bold text-navy-light">부동산 인사이트:</strong> 거주 목적 외 투자 목적 부동산은 시장 분석 및 전문가 자문 필수.</li>
          </ul>
        </AccordionItem>
      </div>
    </section>
